...
public class CategoriaDAO {
	...
	public static boolean save(basededatos.Categoria categoria) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().saveObject(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(basededatos.Categoria categoria) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().deleteObject(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(basededatos.Categoria categoria)throws PersistentException {
		try {
			basededatos.Producto[] lContienes = categoria.contiene.toArray();
			for(int i = 0; i < lContienes.length; i++) {
				lContienes[i].setPertenece_a(null);
			}
	...
	public static boolean refresh(basededatos.Categoria categoria) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().getSession().refresh(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(basededatos.Categoria categoria) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().getSession().evict(categoria);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
