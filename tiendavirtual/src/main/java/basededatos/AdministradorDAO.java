...
public class AdministradorDAO {
	...
	public static boolean save(basededatos.Administrador administrador) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(basededatos.Administrador administrador) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(basededatos.Administrador administrador)throws PersistentException {
		try {
			basededatos.Mensaje[] lGestionas = administrador.gestiona.toArray();
	...
	public static boolean refresh(basededatos.Administrador administrador) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(basededatos.Administrador administrador) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
