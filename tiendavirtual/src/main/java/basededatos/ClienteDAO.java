...
public class ClienteDAO {
	...
	public static boolean save(basededatos.Cliente cliente) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().saveObject(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(basededatos.Cliente cliente) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().deleteObject(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(basededatos.Cliente cliente) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().getSession().refresh(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(basededatos.Cliente cliente) throws PersistentException {
		try {
			TiendavirtualPersistentManager.instance().getSession().evict(cliente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
