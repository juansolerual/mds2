...
<vaadin-vertical-layout theme="spacing" style="width: 100%; height: 100px; flex-direction: row;" id="vaadinVerticalLayout">
 ...
 <vaadin-horizontal-layout theme="spacing"  style="cursor: pointer; align-self: center;" id="vaadinHorizontalLayout">
  <label style="cursor: pointer; width: 100%; height: 100%; margin: var(--lumo-space-m); align-self: center; padding: var(--lumo-space-m);" id="label">Tienda Virtual</label>
 </vaadin-horizontal-layout>
</vaadin-vertical-layout>
<vaadin-vertical-layout id="vaadinVerticalLayout1" style="width: 100%; flex-direction: row;">
 <vaadin-horizontal-layout theme="spacing" id="vaadinHorizontalLayout1" style="margin: var(--lumo-space-m); flex-grow: 1; justify-content: flex-start; flex-direction: row; align-self: center;">
