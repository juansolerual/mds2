...
public class Productos_Administrador extends VistaProductosadministrador{
	...
	public Productos_Administrador(HorizontalLayout horizontalLayout, VerticalLayout verticalLayout,
			VerticalLayout vlayout,
			Visualizar_Pantalla_Principal_Administrador visualizar_Pantalla_Principal_Administrador) {
	    	...
	    	Producto_usuario pu = new Producto_usuario(true);
		      ...
		      pu.editarProducto.addClickListener(new ComponentEventListener<ClickEvent<Button>>() {
				...
				public void onComponentEvent(ClickEvent<Button> event) {
					...
					vlayout.remove(visualizar_Pantalla_Principal_Administrador);
					...
					VistaProductousuario vistaProductoUsuario = new VistaProductousuario(productoUsuario, true);
					vlayout.add(vistaProductoUsuario);
