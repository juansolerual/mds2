...
public class Editar_categoria {
	...
	public Editar_categoria(basededatos.Categoria cat) {
		super();
		dialog = new Dialog();
		...
		nombreCategoria = new TextField("Nombre categoría:");
		...
		if (cat != null) {
			nombreCategoria.setValue(cat.getNombreCategoria());
			descripcion.setValue(cat.getDescripcion());
		}else {
